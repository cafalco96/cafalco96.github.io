...
import { _ as __nuxt_component_0$2 } from "./nuxt-link-D1Ckab9L.js";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/ofetch/dist/node.mjs";
import "#internal/nuxt/paths";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/hookable/dist/index.mjs";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/unctx/dist/index.mjs";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/h3/dist/index.mjs";
import "vue-router";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/radix3/dist/index.mjs";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/defu/dist/defu.mjs";
import "/home/carlos_falconi/Escritorio/carlos-proj/cafalco96.github.io/portfolio-carlos/node_modules/ufo/dist/index.mjs";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.items.length) {
        _push(`<ul${ssrRenderAttrs(mergeProps({ class: "portfolio-small-tiles" }, _attrs))} data-v-ceb61118><!--[-->`);
        ssrRenderList(_ctx.items, (value, i) => {
          _push(`<li class="portfolio-small-tiles__item" data-v-ceb61118><div class="portfolio-small-tiles__tech-icon" data-v-ceb61118>${value.icon ?? ""}</div> ${ssrInterpolate(value.name)}</li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<!---->`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/small-tiles/small-tiles.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-ceb61118"]]), { __name: "SmallTiles" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_small_tiles = __nuxt_component_0$1;
      const _component_nuxt_link = __nuxt_component_0$2;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-hero" }, _attrs))} data-v-90b8bce9><div class="portfolio-hero__image-container" data-v-90b8bce9><img${ssrRenderAttr("src", _ctx.imageSrc)}${ssrRenderAttr("alt", _ctx.imageAlt)} loading="eager" class="portfolio-hero__image" data-v-90b8bce9></div><div class="portfolio-hero__content" data-v-90b8bce9><p data-v-90b8bce9>${ssrInterpolate(_ctx.eyeBrow)}</p><h1 class="portfolio-hero__content-title" data-v-90b8bce9>${ssrInterpolate(_ctx.title)} - <span data-v-90b8bce9>${ssrInterpolate(_ctx.subtitle)}</span></h1><p class="portfolio-hero__content-description" data-v-90b8bce9>${ssrInterpolate(_ctx.description)}</p>`);
      _push(ssrRenderComponent(_component_small_tiles, { items: _ctx.techStack }, null, _parent));
      _push(`<div class="portfolio-hero__button-container" data-v-90b8bce9>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/works",
        class: "btn portfolio-hero__button"
      }, {
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-90b8bce9"]]), { __name: "Hero" });
const wordpressIcon = `<svg
            viewBox="0 0 32 32"
            fill="none"
...
const reactIcon = `<svg
            class="portfolio-hero__tech-icon"
            viewBox="0 0 32 32"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "portfolio-home" }, _attrs))} data-v-45673c18>`);
      _push(ssrRenderComponent(_component_hero, {
        "image-src": "https://i.ibb.co/gMm3nfw1/carlos.webp",
        "image-alt": "Carlos Falconi",
        "eye-brow": "Welcome to my portfolio website!",
        title: "Carlos Alfredo Falconi Lucas",
        subtitle: "Full Stack Developer",
        description: "Fueled by the conviction that no challenge is impossible and growth\n        never ends, I craft innovative web experiences that merge creativity,\n        efficiency, and cutting-edge technology.",
        "tech-stack": [
          { name: "WordPress Development", icon: wordpressIcon },
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-45673c18"]]);
export {
  index as default
};
//# sourceMappingURL=index-siW_fOGL.js.map
